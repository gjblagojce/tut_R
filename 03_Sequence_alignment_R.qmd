...
alignment1 <- pairwiseAlignment(DNAString("ACTG"), DNAString("ACGG"),
                  substitutionMatrix = nucleotideSubstitutionMatrix(match = 1, mismatch = -1), gapOpening = -2, gapExtension = -0.5, type = "global")
...
```{r}
alignment2 <- pairwiseAlignment(seq1, seq2, substitutionMatrix = nucleotideSubstitutionMatrix(match = 2, mismatch = -1, baseOnly = TRUE),
...
```{r}
alignment3 <- pairwiseAlignment(seq1, seq2, substitutionMatrix = nucleotideSubstitutionMatrix(match = 2, mismatch = -1, baseOnly = TRUE),
